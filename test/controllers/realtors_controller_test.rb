...
class RealtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create realtor" do
    assert_difference('Realtor.count') do
      post realtors_url, params: { realtor: { address: @realtor.address, age: @realtor.age, house: @realtor.house, price: @realtor.price, remarkes: @realtor.remarkes } }
    end
  ...
  test "should update realtor" do
    patch realtor_url(@realtor), params: { realtor: { address: @realtor.address, age: @realtor.age, house: @realtor.house, price: @realtor.price, remarkes: @realtor.remarkes } }
